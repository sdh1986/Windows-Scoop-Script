...
function Install-Software {
  $SOFTWARE_NAMES = @(
  "scoop-cn/aria2", "scoop-cn/dark", "scoop-cn/innounp", "scoop-cn/scoop-search"
  )
  
  #$SOFTWARE_NAMES = @(
  #"scoop-cn/aria2", "scoop-cn/dark", "scoop-cn/innounp",  "scoop-cn/scoop-search",
  #"scoop-bucket/cms6", "scoop-cn/wecom", "scoop-cn/wechat",
  #"sparkebucket/univpn-np", "sparkebucket/xylink-np",
  #"sparkebucket/sdriveclient-np", "sparkebucket/sinopharmwps365-np"
  #)
