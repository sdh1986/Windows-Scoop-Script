...
<# $global:cmd = "if (Get-Command -Name scoop -ErrorAction SilentlyContinue) {} else {irm https://ghproxy.com/raw.githubusercontent.com/duzyn/scoop-cn/master/install.ps1 | iex}`n"
...
if(($buckets | Measure-Object).Count -gt 0) {
    append "scoop install https://ghproxy.com/raw.githubusercontent.com/duzyn/scoop-cn/master/bucket/git.json"
    append "scoop update"
